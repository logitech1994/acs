...
$page_title = __('Ошкора бўлимлар ва ҳужжатлар','cftp_admin');
...
<div class="col-xs-12 col-sm-12 col-lg-6 col-lg-offset-3">
		...
		<div class="white-box-interior">
			<div class="text-center">
				<?php
					switch ( $mode ) {
						case 'files':
								$title	= __('Ошкора бўлимлар ва ҳужжатлар','cftp_admin');
								...
								*/
								case 'files':
									if ( empty( $all_files ) && empty( $groups ) ) {
										_e("Ҳужжатлар мавжуд эмас",'cftp_admin');
									}
									else {
	...
	<div class="login_form_links">
		...
		?>
				<p id="register_link"><?php _e("Сиз тизимдан рўйҳатдан ўтканмисиз?",'cftp_admin'); ?> <a href="<?php echo BASE_URI; ?>register.php"><?php _e('Рўйҳатдан ўтиш','cftp_admin'); ?></a></p>
		<?php
			}
		?>
		<p><a href="<?php echo BASE_URI; ?>" target="_self"><?php _e('Асасий саҳифага қайтиш','cftp_admin'); ?></a></p>
	</div>
</div>
