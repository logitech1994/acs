	...
	***********************************************************************************/
	$('body').on('click', '.public_link', function(e) {
		...
		if ( type == 'group' ) {
			...
			var note_text = '<?php _e('URL манзил ёзилган жойига битта босиб манзни нусҳалаб олишингиз мумкин','cftp_admin'); ?>';
		}
		else if ( type == 'file' ) {
			var link_base = '<?php echo PUBLIC_DOWNLOAD_URI; ?>?';
			var note_text = '<?php _e('Рўйҳатдан ўткан холда нусҳалаб олишингиз мумкин','cftp_admin'); ?>';
		}

		var content =  '<div class="public_link_modal">'+
							'<strong><?php _e('Танланг ва нусҳаланг','cftp_admin'); ?></strong>'+
							'<div class="copied"><?php _e('Амалга оширилди','cftp_admin'); ?></div>'+
							'<div class="copied_not"><?php _e('Ҳатолик, қайта уриниб кўринг','cftp_admin'); ?></div>'+
						...
						'</div>';
		var title 	= '<?php _e('URL манзил','cftp_admin'); ?>';
