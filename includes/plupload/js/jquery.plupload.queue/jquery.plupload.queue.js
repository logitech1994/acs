(function (c) {
    ...
    function b(f, e) {
        ...
        e.prepend('<div class="plupload_wrapper plupload_scroll"><div id="' + f + '_container" class="plupload_container"><div class="plupload"><div class="plupload_header"><div class="plupload_header_content"><div class="plupload_header_title">' + a("Hujjatni tanlang") + '</div><div class="plupload_header_text">' + a("Hujjatni bitta tugam orqali yuklab olishingiz mumkin") + '</div></div></div><div class="plupload_content"><div class="plupload_filelist_header"><div class="plupload_file_name">' + a("Faylnomi") + '</div><div class="plupload_file_action">&nbsp;</div><div class="plupload_file_status"><span>' + a("Holati") + '</span></div><div class="plupload_file_size">' + a("Xajmi") + '</div><div class="plupload_clearer">&nbsp;</div></div><ul id="' + f + '_filelist" class="plupload_filelist"></ul><div class="plupload_filelist_footer"><div class="plupload_file_name"><div class="plupload_buttons"><a href="#" class="plupload_button plupload_add">' + a("Tanlash") + '</a><a href="#" class="plupload_button plupload_start">' + a("Yulab boshlandi") + '</a></div><span class="plupload_upload_status"></span></div><div class="plupload_file_action"></div><div class="plupload_file_status"><span class="plupload_total_status">0%</span></div><div class="plupload_file_size"><span class="plupload_total_file_size">0 b</span></div><div class="plupload_clearer">&nbsp;</div></div></div></div></div><input type="hidden" id="' + f + '_count" name="' + f + '_count" value="0" /></div><div class="plupload_progress"><div class="plupload_progress_container progress progress-striped progress-success active"><div class="plupload_progress_bar bar"></div></div></div>')
    }
            ...
            this.each(function () {
                ...
                j.bind("Init", function (l, m) {
                    ...
                    if (l.features.dragdrop && l.settings.dragdrop) {
                        ...
                        c("#" + k + "_filelist").append('<li class="plupload_droptext">' + a("Maydonga ham tashlashingiz mumkin") + "</li>")
                    }
