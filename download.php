...
$page_title = __('Хужжат ҳақида маълумот','cftp_admin');
		...
		<div class="white-box-interior">
			...
			<?php
				...
				if (isset($errorstate)) {
					switch ($errorstate) {
						case 'token_invalid':
							$login_err_message = __("Ҳатолик, қайта уриниб кўринг",'cftp_admin');
							break;
					}
				...
				?>
					<div class="text-center">
						<p><?php _e('Ушбу ҳужжатни хозир юкламоқчимисиз? ','cftp_admin'); ?><br /><strong><?php echo $real_file_url; ?></strong></p>
						...
						<a href="<?php echo $download_link; ?>" class="btn btn-primary">
							<?php _e('Ҳужжатни юклаш','cftp_admin'); ?>
						</a>
					</div>
				<?php
				}
