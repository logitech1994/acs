...
switch ( $form_information['type'] ) {
	case 'new_category':
		$submit_value	= __('Гуруҳ яратиш','cftp_admin');
		break;
	case 'edit_category':
...
<div class="categories_form form-horizontal">
	...
	<div class="form-group">
		<label for="category_name" class="col-sm-4 control-label"><?php _e('Гуруҳ номи','cftp_admin'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="category_description" class="col-sm-4 control-label"><?php _e('Қисқача маълумот','cftp_admin'); ?></label>
		<div class="col-sm-8">
	...
	<div class="inside_form_buttons">
		<?php if ( $show_cancel === true ) { ?>
			<a href="<?php echo BASE_URI; ?>categories.php" name="cancel" class="btn btn-wide btn-default"><?php _e('Бекор қилиш','cftp_admin'); ?></a>
		<?php } ?>
