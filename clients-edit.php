...
$page_title = __('Аудитларни тахрирлаш панели','cftp_admin');
if (isset($add_client_data_user) && $global_user == $add_client_data_user) {
...
<div class="col-xs-12 col-sm-12 col-lg-12">
	<?php
		if (isset($_GET['status'])) {
			...
			switch ($_GET['status']) {
				case 1:
					$msg = __('Аудит тахрирланди','cftp_admin');
	...
	<div class="white-box">
		<div class="white-box-interior">
			...
			<?php
				...
				if ($page_status === 0) {
					$msg = __('Аудит танланмади','cftp_admin');
					echo system_message('error',$msg);
					...
					$msg = __("Сизнинг саҳифангиз администратор тамонидан тасдиқланмади",'cftp_admin');
					echo system_message('error',$msg);
				}
				else {
					/**
